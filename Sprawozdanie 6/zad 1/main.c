...
void display() {
    ...
    glMaterialfv( GL_FRONT_AND_BACK, GL_AMBIENT, materials[10]);
    glMaterialfv( GL_FRONT_AND_BACK, GL_DIFFUSE, materials[10]);
    glMaterialfv( GL_FRONT_AND_BACK, GL_SPECULAR, materials[10]);
    glMaterialf( GL_FRONT_AND_BACK, GL_SHININESS, materials[10][12] );
...
void initGL() {
    ...
    float red2 [4] = {0.9, 0, 0, 1};
    float red3 [4] = {0.2, 0, 0, 1};
    glLightfv (GL_LIGHT1, GL_DIFFUSE, red1);
    glLightfv (GL_LIGHT1, GL_SPECULAR, red2);
    glLightfv (GL_LIGHT1, GL_AMBIENT, red3);
}  // end initGL()

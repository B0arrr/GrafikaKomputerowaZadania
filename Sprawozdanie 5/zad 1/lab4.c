...
void draw() {
    ...
    switch(objectNumber)
    {
        case 1:
            ...
            {
                r= (float) (a*exp(b * (float)alfa * rad));
                glVertex3f((float)(r*cos((float)alfa * rad)), (float)(r * sin((float)alfa * rad)), z);
                z+=0.002;
            }
            glEnd();
            break;
        case 2:
            ...
            glVertex3f(5.4f,0.7f,4.0f);
            glVertex3f(4.3f,3.3f,4.0f);
            glVertex3f(2.1f,5.0f,4.0f);
            glVertex3f(-0.7f,5.4,4.0f);
            glVertex3f(-3.3f,4.3f,4.0f);
            glVertex3f(-5.0f,2.1f,4.0f);
            glVertex3f(-5.4f,-0.7f,4.0f);
            glVertex3f(-4.3f,-3.3f,4.0f);
            glVertex3f(-2.1f,-5.0f,4.0f);
            glVertex3f(0.7f,-5.4f,4.0f);
            glVertex3f(3.3f,-4.3f,4.0f);
            glVertex3f(5.0f,-2.1f,4.0f);
            glVertex3f(5.4f,0.7f,4.0f);
